/*
- LocalStorage
  - On page load retrieve or create local storage
  - If create, insert fields 
    - Generate user id
    - Mobile/Desktop
    - Device
...
- After page is completely loaded
  - POST via fetch
    ...
    - current url
    - title
let full_path = window.location.xref;
let path = window.location.pathname; // without host name
let title = window.title;
let origin = window.origin;
let referrer = document.referrer;
*/

// Taken from SO don't ask me about it.
...
function getPayload() {
    let isNewVisitor = localStorage.getItem("user_id") === null;
    if (isNewVisitor) {
        localStorage.setItem("user_id", guidGenerator());
    ...
    let payload = {
        ...
        "full_path": window.location.xref,

        "user_id": localStorage.getItem("user_id"),
        "is_mobile": localStorage.getItem("is_mobile")
    };
